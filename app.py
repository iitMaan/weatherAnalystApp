...
sys.path.append(os.path.abspath("E:/Sustainable_travel_app_main/pathway"))
...
import nltk
nltk.data.path.append('/home/greninja07/Downloads/Sustainable_travel_app/Sustainable_travel_app_main')
nltk.download('averaged_perceptron_tagger', download_dir='/home/greninja07/Downloads/Sustainable_travel_app/Sustainable_travel_app_main')
